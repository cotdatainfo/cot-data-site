  ...
  return (
    <div className="mb-6 bg-blue-500/10 border border-blue-500/30 rounded-lg overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2.5 hover:bg-blue-500/5 transition-colors"
      >
        <div className="flex items-center gap-2">
          <Info className="w-4 h-4 text-blue-400" />
          <h3 className="text-blue-400 font-semibold text-sm">Understanding COT Data</h3>
        </div>
        {isExpanded ? (
        ...
        <div className="px-4 pb-3 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div className="bg-gray-800/50 rounded-lg p-3">
              <h4 className="text-white font-semibold mb-1.5 text-sm">📊 Index (Open Interest)</h4>
              <p className="text-gray-400 text-xs">
            ...
            {/* Commercial */}
            <div className="bg-gray-800/50 rounded-lg p-3">
              <h4 className="text-white font-semibold mb-1.5 text-sm">🏢 Commercial</h4>
              <p className="text-gray-400 text-xs">
            ...
            {/* Speculators */}
            <div className="bg-gray-800/50 rounded-lg p-3">
              <h4 className="text-white font-semibold mb-1.5 text-sm">💰 Speculators</h4>
              <p className="text-gray-400 text-xs">
          ...
          <div className="bg-gray-800/50 rounded-lg p-3">
            <h4 className="text-white font-semibold mb-1.5 text-sm">🎯 How to Read This</h4>
          ...
          <div className="bg-gray-800/50 rounded-lg p-3">
            <h4 className="text-white font-semibold mb-1.5 text-sm">📚 What is CFTC?</h4>
